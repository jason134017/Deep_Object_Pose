...
#python -m torch.distributed.launch --nproc_per_node=1 train.py --network dope --epochs 60 --batchsize 4 --outf tmp/ --data ../nvisii_data_gen/output/dataset
#--net tmp/net_epochs_60.pth --ir 0.01
