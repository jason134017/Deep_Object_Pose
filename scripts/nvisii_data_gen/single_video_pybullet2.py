...
from utils import *
#python single_video_pybullet2.py --nb_frames 200 --nb_objects 10 --nb_distractors 5
...
for i_obj in range(int(opt.nb_objects)):
    ...
    texture_to_load = toy_to_load + "/google_16k/texture.jpg"

    #obj_to_load = "models/Coke" + "/cola_can.obj"
    #texture_to_load = "models/Coke" + "/Cola_Can_albedo.png"

    # obj_to_load = toy_to_load + "/google_16k/uploads_files_2701956_BOTTOL+3.obj"
    # texture_to_load = toy_to_load + "/google_16k/4b0197d76b12e9cbb81b4f78c4ac3d40.jpg"
